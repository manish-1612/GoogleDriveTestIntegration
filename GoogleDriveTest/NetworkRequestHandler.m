                                                ...
                                                else
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        for (NSString *key in simpleDataKeys){
                                                            ...
                                                            NSData *simpleData ;                                                            
                                                            if ([[simpleDataDictionary objectForKey:key] isKindOfClass:[NSArray class]] ||
                                                                [[simpleDataDictionary objectForKey:key] isKindOfClass:[NSDictionary class]]) {
                                                                
                                                                NSError* error = nil;
                                                                simpleData = [NSJSONSerialization dataWithJSONObject:[simpleDataDictionary objectForKey:key] options:NSJSONWritingPrettyPrinted error:&error];
                                                            }else{
                                                                
                                                                simpleData=[[simpleDataDictionary objectForKey:key]  dataUsingEncoding:NSUTF8StringEncoding];
                                                            }
...
-(void)startUploadWithPutMethod{
    ...
    __block NSMutableURLRequest *request = [client multipartFormRequestWithMethod:@"PUT"
                                                                             path:@""
                                                                       parameters:nil
                                                        constructingBodyWithBlock:
                                            ^(id <AFMultipartFormData>formData)
